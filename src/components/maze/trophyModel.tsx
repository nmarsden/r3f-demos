...
Command: npx gltfjsx@6.2.13 public/maze/trophy_clash_royale.glb -o trophyModel.tsx --transform -j --types 
Files: public/maze/trophy_clash_royale.glb [1.05MB] > trophy_clash_royale-transformed.glb [95.95KB] (91%)
...
export function TrophyModel(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/r3f-demos/maze/trophy_clash_royale-transformed.glb') as GLTFResult
  return (
...
useGLTF.preload('/r3f-demos/maze/trophy_clash_royale-transformed.glb')
